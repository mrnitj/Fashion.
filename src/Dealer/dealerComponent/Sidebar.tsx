...
const AppBar = styled(MuiAppBar, {
    ...
    backgroundColor: "grey", // Set the background color here
    ...(open && {
...
export const Sidebar = () => {
    ...
    const [sideBarChilder, setSideBarChilder] = React.useState(<Users />);
        ...
        <Box sx={{ display: "flex" }}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant="h4" noWrap component="div" sx={{ letterSpacing: ".2rem", fontFamily: "Mina" }}>
                        DEALER
                    </Typography>
                </Toolbar>
            </AppBar>
